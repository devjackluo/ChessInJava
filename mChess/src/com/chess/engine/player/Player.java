...
public abstract class Player {
    ...
    Player(final Board board,
        ...
        this.castleMoves = calculateKingCastles(playerLegals, opponentLegals);
    ...
    public MoveTransition makeMove(final Move move) {
        ...
        if (!kingAttacks.isEmpty()) {
            return new MoveTransition(this.board, this.board, move, Move.MoveStatus.LEAVES_PLAYER_IN_CHECK);
        }
        return new MoveTransition(this.board, transitionedBoard, move, Move.MoveStatus.DONE);
    }
